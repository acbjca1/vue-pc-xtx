<template>
  <div class="goods-comment">
    ...
    <div class="sort" v-if="commentInfo">
      ...
      <a
        href="javascript:;"
        :class="{ active: reqParams.sortField === 'creteTime' }"
        @click="changeSort('creteTime')"
        >最新</a
      >
      <a
        href="javascript:;"
...
export default {
  ...
  setup() {
    ...
    const reqParams = reactive({
      ...
      hasPicture: null,
      tag: null,
      // 排序方式：praiseCount 热度 creteTime 最新
      sortField: null
    })
    ...
    return { commentInfo, currentTagIndex, changeTag, reqParams, commentList, changeSort, formatSpecs, formatNickname, changePagerFn }
  }
}
</script>
